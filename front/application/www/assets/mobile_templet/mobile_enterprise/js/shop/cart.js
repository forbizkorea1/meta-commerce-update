...
function relation_checkbox($all_checkbox, $target_checkbox) {
    ...
    $target_checkbox.on("click", function() {
...
var devCartObj = {
    ...
    initEvent: function() {
        ...
        $('.devCountUpdateButton').click(function () {
            ...
            common.ajax(common.util.getControllerUrl('updateCount', 'cart'), data, "", function (result) {
                ...
                //장바구니 수량보다 재고가 많을경우
                    ...
                    common.noti.tailMsg('devCountUpdateButton', common.lang.get('cart.update.count.failStockLack.alert', {count: result.data}));
        ...
        //홈으로
        $(document).on('click', '#devHomeButton', function () {
