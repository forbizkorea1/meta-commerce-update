 ...
 * 퍼블 *
 *--------------------------------------------------------------*/
$(".js__couponPop--accd").on("click", function() {
    var $this = $(this);
...
var devCouponPopObj = {
    ...
    getCouponInfoBySelect: function ($select) {
        ...
        var companyId = $select.attr('devCartCouponSelect');
        ...
        return {cartIx: cartIx, companyId: companyId, registIx: registIx,
            totalCouponWithDcprice: totalCouponWithDcprice
            , discountAmount: discountAmount, couponDIv: couponDIv}
    },
    changeCouponText: function (cartIx, totalCouponWithDcprice, discountAmount) {
        if (totalCouponWithDcprice >= 0) {
            ...
            $('select[devCouponSelect]').val('쿠폰선택');
        }
    },
