 ...
 * 개발 *
 *--------------------------------------------------------------*/
var devProductListProductApprovalObj = {
    initLang: function () {
        // 글로벌 언어셋 설정
    ...
    initListGrid: function () {
        ...
        .setUseHash(false)
        .setUrl(common.util.getControllerUrl('get', 'listProductApproval', 'product'))
        ...
        $('#devExcelDownload').on('click', function (e) {
            self.pagingGrid.excelDown(common.util.getControllerUrl('dwn', 'listProductApproval', 'product'));
        });
    },
    initForm: function () {
        var self = this;
        ...
        common.form.init($form, common.util.getControllerUrl('put', 'listProductApproval', 'product'),
            function (formData) {
...
$(function () {
    devProductListProductApprovalObj.run();
});