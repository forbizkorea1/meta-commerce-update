 ...
 * 개발 *
 *--------------------------------------------------------------*/
var devProductBatchChangeMobileObj = {
    initLang: function () {
        // 글로벌 언어셋 설정
        ...
        common.lang.load('grid.label.mobileText', '전시타입');
    ...
    initPagingGrid: function () {
        ...
        var gridConfig = {
            ...
            columns: [
                ...
                {key: "mobileText", label: common.lang.get('grid.label.mobileText'), width: 80, align: 'center'},
        ...
        self.listGrid.setGrid($('#devPagingGrid'), gridConfig)
            ...
            .setUrl(common.util.getControllerUrl('get', 'batchChangeMobile', 'product'))
        ...
        $('#devExcelDownload').on('click', function (e) {
            grid.excelDown(common.util.getControllerUrl('dwn', 'batchChangeMobile', 'product'));
        });
    },
    initBatch: function () {
    ...
    initForm: function () {
        ...
        // 입력/수정폼 설정
        common.form.init($form, common.util.getControllerUrl('put', 'batchChangeMobile', 'product'),
            function (formData) {
                var ids = devProductBatchChangeMobileObj.listGrid.getList('selected', ['id']);
                if (ids == false) {
...
$(function () {
    devProductBatchChangeMobileObj.run();
