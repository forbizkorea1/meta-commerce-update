 ...
 */
class SalesStatisticsDetail extends \ForbizAdminController
{
...
//            $pathData = $categoryModel->getCategoryPath($type_value, 3);
    ...
    public function get()
    {
        ...
        if (form_validation($chkField)) {
            ...
            if($st_div == 'product'){
                $ret = $this->statisticsModel->getStatisticsProductList($type,$type_value,$startDate,$endDate);
            }else{
                $ret = $this->statisticsModel->getStatisticsDetailList($type,$type_value,$st_div,$startDate,$endDate);
            }
    ...
    public function dwnAsync()
    {
        ...
        if (form_validation($chkField)) {
            ...
            $asyncData = array(
                'pageName' => 'salesStatisticsDetail'
