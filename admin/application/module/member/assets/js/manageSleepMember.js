 ...
 * 개발 *
 *--------------------------------------------------------------*/
var devMemberManageSleepMemberObj = {
    initLang: function () {
    ...
    initForm: function () {
        ...
        common.form.init(
                $('#devModifyForm'),
                common.util.getControllerUrl('put', 'manageSleepMember', 'member'),
                function (formData) {
    ...
    initPagingGrid: function () {
        ...
        var gridConfig = {
            ...
            columns: [
                ...
                {key: "visit", label: common.lang.get('grid.label.visit'), width: 150, align: "left"},
                {key: "mileage", label: common.lang.get('grid.label.mileage'), width: 150, align: "left"},
            ]
        };
        // 그리드 연동
...
$(function () {
    devMemberManageSleepMemberObj.run();
});