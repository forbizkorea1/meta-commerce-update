 ...
 * 개발 *
 *--------------------------------------------------------------*/
var devMemberBatchGiveMileageObj = {
    initLang: function () {
        ...
        common.lang.load('common.give.mileage.alert', '마일리지 변경이 완료되었습니다.');
        common.lang.load('common.fail.count.alert', '변경할 회원을 선택하세요.');
    ...
    initForm: function () {
        ...
        common.form.init(
                $('#devModifyForm'),
                common.util.getControllerUrl('add', 'batchGiveMileage', 'member'),
                function (formData) {
                ...
                function (response) {
                    if (response.result == 'success') {
                        common.noti.alert(common.lang.get('common.give.mileage.alert'));
                    } else {
    ...
    checkValidation: function () {
        ...
        common.validation.set($('[name=reserve]'), {'required': true});
    },
...
$(function () {
    devMemberBatchGiveMileageObj.run();
});