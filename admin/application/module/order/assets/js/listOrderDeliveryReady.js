 ...
 * 개발 *
 *--------------------------------------------------------------*/
var devOrderListOrderDeliveryReadyObj = {
    initLang: function () {
        // 글로벌 언어셋 설정
    ...
    initGrid: function () {
        ...
        self.grid.setGrid($('#devPagingGrid'), gridConfig)
                ...
                .setUrl(common.util.getControllerUrl('get', 'listOrderDeliveryReady', 'order'))
                .on('click', function (e) {
                    if (e.column.key == 'oid') {
    ...
    initForm: function () {
        var self = this;
        common.form.init($('#devModifyForm'), common.util.getControllerUrl('put', 'listOrderDeliveryReady', 'order'), function (formData, $form) {
    ...
    initEvent: function () {
        ...
        $('#devExcelDownload').on('click', function (e) {
            ...
            if (excelTmpIx) {
                self.grid.excelDown(common.util.getControllerUrl('dwn', 'listOrderDeliveryReady', 'order'), {excelTmpIx: excelTmpIx});
            } else {
        ...
        $('.devStatus').click(function () {
            ...
            var $allOptions = $('.devChangeStatusOption');
            $allOptions.hide();
            common.validation.set($allOptions.find('.devRequired'), {required: false});

            var $selectOptions = $('.devChangeStatusOption[devStatus=' + status + ']');
            $selectOptions.show();
...
$(function () {
    devOrderListOrderDeliveryReadyObj.run();
});