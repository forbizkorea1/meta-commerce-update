 ...
 * 개발 *
 *--------------------------------------------------------------*/
var devOrderListOrderCancelObj = {
    initLang: function () {
        // 글로벌 언어셋 설정
        ...
        common.lang.load('grid.label.ca_date', '취소요청일자');
        common.lang.load('grid.label.cc_date', '취소완료일자');
    ...
    initGrid: function () {
        ...
        var gridConfig = {
            ...
            columns: self.getAuthGridColumns([
                ...
                {key: "ca_date", label: common.lang.get('grid.label.ca_date'), width: 130, align: 'center'},
                {key: "cc_date", label: common.lang.get('grid.label.cc_date'), width: 130, align: 'center'}
            ]),
            body: {
                mergeCells: ["oid"]
            }
    ...
    initForm: function () {
        var self = this;
        common.form.init($('#devModifyForm'), common.util.getControllerUrl('put', 'listOrderCancel', 'order'), function (formData, $form) {
...
$(function () {
    devOrderListOrderCancelObj.run();
});