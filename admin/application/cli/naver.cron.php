...
(new class extends ForbizCli
{
    ...
    {
        echo "-------사용법-------\n";
        echo "naverEpAll: ep 전체 파일 생성\n";
        echo "naverEpBrief: ep 요약 파일 생성\n";
    }

    /**
     * 전체ep [업데이트 주기 : 01시 (1일 1회), 품절이 아니면서 구매 가능한]
     */
    public function naverEpAll()
    {
        $this->setEp('all');
    }
    ...
    {
        /* @var $naverEpModel \CustomScm\Model\Util\NaverEp */
        $naverEpModel = $this->import('model.scm.util.naverEp');

        $naverEpModel->setEp($type);
